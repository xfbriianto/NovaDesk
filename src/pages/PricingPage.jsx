...
const PricingPage = () => {
  return (
    <main className="relative pt-32 pb-24 px-4 md:px-10 max-w-[1440px] mx-auto">
  {/* Background Orbs */}
  ...
  {/* ... konten lainnya */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center relative z-10">
        ...
        <div className="glass-card p-10 rounded-xl flex flex-col h-full">
          ...
          <button className="w-full py-4 border border-outline text-white rounded-full font-bold hover:bg-white/5 transition-all">
            Get Started
          </button>
        </div>

        {/* Pro Plan (Featured) */}
        <div className="glass-card pro-glow p-10 rounded-xl flex flex-col h-full bg-surface-container-low border-primary/40 md:scale-105 relative">
          ...
          <button className="w-full py-4 bg-primary-container text-on-primary-container rounded-full font-bold hover:shadow-[0_0_20px_rgba(124,58,237,0.4)] transition-all">
            Start Pro
          </button>
        </div>
      ...
      <div className="mt-24 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-12 opacity-40 grayscale contrast-125">
          <div className="h-8 w-24 bg-on-surface-variant/20 rounded-md"></div>
          <div className="h-8 w-28 bg-on-surface-variant/20 rounded-md"></div>
          <div className="h-8 w-20 bg-on-surface-variant/20 rounded-md"></div>
